        ...
        this.onMessage(async (context, next) => {
           ...
           if (didBotWelcomedUser == 0)  //FALSE - FIRST WELCOME
                ...
                //await context.sendActivity("Welcome");
                 ...
                 welcomeCard.body[5].text = 'Keywords search the index of clauses, or in the General Conditions when searching is activated (by submitting \"c1s\" or  \"start\" -> \"c1 s\" for Construction Contract).';
        ...
        this.onMembersAdded(async (context, next) => { 
            ...
            for (let cnt = 0; cnt < membersAdded.length; cnt++) {
                ...
                if (membersAdded[cnt].id !== context.activity.recipient.id) {
                 ...
                 welcomeCard1.body[5].text = 'Keywords search the index of clauses, or in the General Conditions when searching is activated (by submitting \"c1s\" or  \"start\" -> \"c1 s\" for Construction Contract).';
