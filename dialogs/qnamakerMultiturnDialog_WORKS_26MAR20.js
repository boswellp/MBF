...
console.log("change knowledge base = " + this._userKBAccessor.kB) 
...
async changeContract(stepContext, userState) { 
       ...
       console.log("\n972 currentQuery  = " + currentQuery);
       console.log("\n973 currentContract  = " + currentContract + "\n");
       console.log("\n974 ProfileAccessor.profileName = " + this._userProfileAccessor.profileName);
       console.log("\n975 userSearchAccessor.searchType = " + this._userSearchAccessor.searchType);
